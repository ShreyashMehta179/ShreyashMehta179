  ...
  <tr>
    <td width="100%" valign="top">
      ...
      <ul>
        ...
        <li>Worked on embedded system development, sensor integration and hardware interfacing.</li>
        <li>Contributed to functional automation prototypes.</li>
      </ul>
    </td>
  </tr>
  <tr>
    <td width="100%" valign="top">
      ...
      <ul>
        ...
        <li>Worked on Android application development and architecture patterns.</li>
        <li>Practiced modern mobile development standards and completed project-based internship activities.</li>
      </ul>
    </td>
  </tr>
</table>
...
<table width="100%">
  ...
  <tr>
    <td width="100%" valign="top">
      <h3>🏫 Dr. D. Y. Patil Polytechnic, Kasaba Bawada</h3>
      <p><b>Diploma:</b> Diploma in Computer Science and Engineering &nbsp;|&nbsp; <b>Duration:</b> 2020 – 2023</p>
      <p><b>Performance:</b> Percentage: <b>89.53%</b> &nbsp;|&nbsp; <b>Location:</b> Kolhapur, India</p>
    </td>
  </tr>
</table>
